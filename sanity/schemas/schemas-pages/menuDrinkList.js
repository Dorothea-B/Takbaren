...
const menuDrinkList = {
  title: "Drink list without image",
  name: "menuDrinkList",
  type: "document",
  fields: [
    {
          ...
          styles: [
            {
              title: "Heading Dark",
              value: "heading-dark",
              blockEditor: { render: HeadingDark },
            },
            {
              title: "Heading Light",
              value: "heading-light",
              blockEditor: { render: HeadingLight },
            },

            {
              title: "Medium Heading Dark",
              value: "m-heading-dark",
              blockEditor: { render: MediumHeadingDark },
            },
            {
              title: "Medium Heading Light",
              value: "m-heading-light",
              blockEditor: { render: MediumHeadingLight },
            },
            {
              title: "Medium Heading Red",
              value: "m-heading-red",
              blockEditor: { render: MediumHeadingRed },
            },

            {
              title: "Sub-Heading Dark",
              value: "sh-dark",
              blockEditor: { render: SubHeadingDark },
            },
            {
              title: "Sub-Heading Light",
              value: "sh-light",
              blockEditor: { render: SubHeadingLight },
            },
            {
              title: "Sub-Heading Red",
              value: "sh-red",
              blockEditor: { render: SubHeadingRed },
            },
            {
              title: "Sub-Heading Pink",
              value: "sh-pink",
              blockEditor: { render: SubHeadingPink },
            },

            {
              title: "Main text Dark",
              value: "main-dark",
              blockEditor: { render: MainTextDark },
            },
            {
              title: "Main text Light",
              value: "main-light",
              blockEditor: { render: MainTextLight },
            },
            {
              title: "Main text Red",
              value: "main-red",
              blockEditor: { render: MainTextRed },
            },
            {
              title: "Main text Pink",
              value: "main-pink",
              blockEditor: { render: MainTextPink },
            },

            {
              title: "Main Link Dark",
              value: "main-link-dark",
              blockEditor: { render: MainLinkDark },
            },
            {
              title: "Main Link Light",
              value: "main-link-light",
              blockEditor: { render: MainLinkLight },
            },

            {
              title: "Regular text Dark",
              value: "reg-dark",
              blockEditor: { render: RegularTextDark },
            },
            {
              title: "Regular text Light",
              value: "reg-light",
              blockEditor: { render: RegularTextLight },
            },
            {
              title: "Regular text Red",
              value: "reg-red",
              blockEditor: { render: RegularTextRed },
            },
            {
              title: "Regular text Pink",
              value: "reg-pink",
              blockEditor: { render: RegularTextPink },
            },

            {
              title: "Regular Link Dark",
              value: "link-dark",
              blockEditor: { render: RegularLinkDark },
            },
            {
              title: "Regular Link Light",
              value: "link-light",
              blockEditor: { render: RegularLinkLight },
            },
            {
              title: "Regular Link Red",
              value: "link-red",
              blockEditor: { render: RegularLinkRed },
            },
          ],
        },
      ],
